...
namespace Aprovi.Data.Models
{
    ...
    public partial class CNEntities : DbContext
    {
        ...
        public virtual DbSet<VwReporteListaDePrecio> VwReporteListaDePrecios { get; set; }
        public virtual DbSet<VwReporteListaDePreciosConImpuesto> VwReporteListaDePreciosConImpuestos { get; set; }
        public virtual DbSet<VwReporteListaDePreciosPorLista> VwReporteListaDePreciosPorListas { get; set; }
        public virtual DbSet<VwReporteListaDePreciosPorListaConImpuesto> VwReporteListaDePreciosPorListaConImpuestos { get; set; }
