...
{
    public class ViewSalidasPorRemisionesRepository : BaseRepository<VwSalidasPorRemisione>, IViewSalidasPorRemisionesRepository
    {
        public ViewSalidasPorRemisionesRepository(CNEntities context) : base(context) { }

        public List<VwSalidasPorRemisione> List(int idItem, DateTime start, DateTime end)
        {
            try
            {
