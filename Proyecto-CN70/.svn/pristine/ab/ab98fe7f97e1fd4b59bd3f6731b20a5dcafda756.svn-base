...
namespace Aprovi.Business.ViewModels
{
    ...
    public class VMArticulo : Articulo
    {
        ...
        public VMArticulo(Articulo item) : base()
        {
            ...
            this.CodigosDeArticuloPorProveedors = item.CodigosDeArticuloPorProveedors;
            this.CodigosDeArticuloPorClientes = item.CodigosDeArticuloPorClientes;
        ...
        public Articulo ToArticulo()
        {
            ...
            local.CodigosDeArticuloPorProveedors = this.CodigosDeArticuloPorProveedors;
            local.CodigosDeArticuloPorClientes = this.CodigosDeArticuloPorClientes;
