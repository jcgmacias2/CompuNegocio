...
{
    public class ViewEntradasPorAjustesRepository : BaseRepository<VwEntradasPorAjuste>, IViewEntradasPorAjustesRepository
    {
        public ViewEntradasPorAjustesRepository(CNEntities context) : base(context) { }

        public List<VwEntradasPorAjuste> List(int idItem, DateTime start, DateTime end)
        {
            try
            {
