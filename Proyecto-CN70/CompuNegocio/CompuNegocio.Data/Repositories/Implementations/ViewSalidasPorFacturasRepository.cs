...
{
    public class ViewSalidasPorFacturasRepository: BaseRepository<VwSalidasPorFactura>, IViewSalidasPorFacturasRepository
    {
        public ViewSalidasPorFacturasRepository(CNEntities context) : base(context) { }

        public List<VwSalidasPorFactura> List(int idItem, DateTime start, DateTime end)
        {
            try
            {
