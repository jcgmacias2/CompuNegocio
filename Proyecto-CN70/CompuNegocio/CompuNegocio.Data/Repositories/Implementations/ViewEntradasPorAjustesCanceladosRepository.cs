...
{
    public class ViewEntradasPorAjustesCanceladosRepository : BaseRepository<VwEntradasPorAjustesCancelado>, IViewEntradasPorAjustesCanceladosRepository
    {
        public ViewEntradasPorAjustesCanceladosRepository(CNEntities context) : base(context) { }

        public List<VwEntradasPorAjustesCancelado> List(int idItem, DateTime start, DateTime end)
        {
            try
            {
