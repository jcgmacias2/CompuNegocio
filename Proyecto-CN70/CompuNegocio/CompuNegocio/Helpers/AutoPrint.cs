...
namespace Aprovi.Application.Helpers
{
    ...
    public class AutoPrint : PrintDocument
    {
        ...
        public AutoPrint(ServerReport serverReport, string printerName)
            : this((Report)serverReport, printerName)
        {
            RenderAllServerReportPages(serverReport);
        }

        public AutoPrint(LocalReport localReport, string printerName)
            : this((Report)localReport, printerName)
        {
        ...
        private AutoPrint(Report report, string printerName)
        {
            // Set the page settings to the default defined in the report
        ...
        protected override void OnPrintPage(PrintPageEventArgs e)
        {
            ...
            using (Metafile pageMetaFile = new Metafile(pageToPrint))
            {
                ...
                //MT Hack
                //It always printed a second page
                //if (m_pages.Count.Equals(2))
