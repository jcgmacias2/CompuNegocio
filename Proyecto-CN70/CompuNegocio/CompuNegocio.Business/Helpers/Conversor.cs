...
namespace Aprovi.Business.Helpers
{
    public sealed class Conversor
    {
        ...
        public Conversor(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return Conversor.ToString(Numero, CultureInfo.CurrentCulture);
        }
